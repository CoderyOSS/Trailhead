...
const DC = {
  ...
  label: 'rgba(232,234,238,0.6)',
  title: 'rgba(243,244,246,0.92)',
  subtitle: 'rgba(232,234,238,0.58)',
  postitBg: '#fef4a8',
  postitText: '#5a4a2a',
...
// Focus is ephemeral.
// ─────────────────────────────────────────────────────────────
const DC_STATE_FILE = '.node-system-canvas.state.json';
  ...
  return (
    <div ref={ref} data-dc-slot={id} style={{ position: 'relative', flexShrink: 0 }}>
      ...
      <div ref={cardRef} className="dc-card"
        style={{ borderRadius: 2, boxShadow: '0 1px 3px rgba(0,0,0,.3),0 4px 16px rgba(0,0,0,.35)', overflow: 'hidden', width, height, background: 'var(--co-bg-1)', ...style }}>
    ...
    <div onClick={() => ctx.setFocus(null)}
      ...
      <div
        ...
        <div onClick={(e) => e.stopPropagation()} style={{ width: width * scale, height: height * scale, position: 'relative' }}>
          <div style={{ width, height, transform: `scale(${scale})`, transformOrigin: 'top left', background: 'var(--co-bg-1)', borderRadius: 2, overflow: 'hidden',
